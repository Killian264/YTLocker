...
export const PrivacyPolicy: React.FC<ClassNameProp> = ({ className, OnBack }) => {
	return (
		<div className="bg-primary-700 absolute top-0 bottom-0 left-0 right-0 mx-auto my-auto w-full h-full md:w-9/12 md:h-5/6 border-2 overflow-scroll p-5 rounded overflow-x-hidden">
			<div className="flex justify-between">
				<h1 className="pb-3 pt-3 text-3xl font-bold">Privacy Policy</h1>
			...
			<p className="pb-3 pt-3">Last updated: October 05, 2021</p>
			...
			<h1 className="pb-3 pt-3 text-3xl font-bold">Interpretation and Definitions</h1>
			<h2 className="pb-3 pt-3 text-2xl font-bold">Interpretation</h2>
			<p className="pb-3 pt-3">
				The words of which the initial letter is capitalized have meanings defined under the following
				conditions. The following definitions shall have the same meaning regardless of whether they
				appear in singular or in plural.
			</p>
			<h2 className="pb-3 pt-3 text-2xl font-bold">Definitions</h2>
			<p className="pb-3 pt-3">For the purposes of this Privacy Policy:</p>
			<ul>
				...
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">
						...
						this Agreement) refers to YTLocker.
					</p>
				</li>
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">
				...
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">
						<strong>Country</strong> refers to: South Dakota, United States
					</p>
				</li>
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">
			...
			<h1 className="pb-3 pt-3 text-3xl font-bold">Collecting and Using Your Personal Data</h1>
			<h2 className="pb-3 pt-3 text-2xl font-bold">Types of Data Collected</h2>
			<h3>Personal Data</h3>
			<p className="pb-3 pt-3">
			...
			<ul>
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">Email address</p>
				</li>
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">Usage Data</p>
				</li>
			</ul>
			<h3>Usage Data</h3>
			<p className="pb-3 pt-3">Usage Data is collected automatically when using the Service.</p>
			<p className="pb-3 pt-3">
			...
			<ul>
				<li className="list-disc ml-8">Google</li>
				<li className="list-disc ml-8">Facebook</li>
				<li className="list-disc ml-8">Twitter</li>
			</ul>
			<p className="pb-3 pt-3">
			...
			<ul>
				<li className="list-disc ml-8">
					...
					<p className="pb-3 pt-3">Type: Session Cookies</p>
					<p className="pb-3 pt-3">Administered by: Us</p>
					<p className="pb-3 pt-3">
				...
				<li className="list-disc ml-8">
					...
					<p className="pb-3 pt-3">Type: Persistent Cookies</p>
					<p className="pb-3 pt-3">Administered by: Us</p>
					<p className="pb-3 pt-3">
			...
			<h2 className="pb-3 pt-3 text-2xl font-bold">Use of Your Personal Data</h2>
			<p className="pb-3 pt-3">The Company may use Personal Data for the following purposes:</p>
			<ul>
				<li className="list-disc ml-8">
					<p className="pb-3 pt-3">
			...
			<p className="pb-3 pt-3">We may share Your personal information in the following situations:</p>
			<ul>
				<li className="list-disc ml-8">
				...
				<li className="list-disc ml-8">
					...
					and may be publicly distributed outside. If You interact with other users or register
			...
			<h2 className="pb-3 pt-3 text-2xl font-bold">Retention of Your Personal Data</h2>
			<p className="pb-3 pt-3">
			...
			<h2 className="pb-3 pt-3 text-2xl font-bold">Transfer of Your Personal Data</h2>
			<p className="pb-3 pt-3">
			...
			<h2 className="pb-3 pt-3 text-2xl font-bold">Disclosure of Your Personal Data</h2>
			...
			<ul>
				<li className="list-disc ml-8">Comply with a legal obligation</li>
				<li className="list-disc ml-8">Protect and defend the rights or property of the Company</li>
				<li className="list-disc ml-8">
				...
				<li className="list-disc ml-8">Protect against legal liability</li>
			</ul>
			<h2 className="pb-3 pt-3 text-2xl font-bold">Security of Your Personal Data</h2>
			<p className="pb-3 pt-3">
			...
			<h1 className="pb-3 pt-3 text-3xl font-bold">Children's Privacy</h1>
			<p className="pb-3 pt-3">
			...
			<h1 className="pb-3 pt-3 text-3xl font-bold">Links to Other Websites</h1>
			<p className="pb-3 pt-3">
			...
			<h1 className="pb-3 pt-3 text-3xl font-bold">Changes to this Privacy Policy</h1>
			<p className="pb-3 pt-3">
			...
			<h1 className="pb-3 pt-3 text-3xl font-bold">Contact Us</h1>
			<p className="pb-3 pt-3">
				If you have any questions about this Privacy Policy, You can contact us:
			</p>
			<ul>
				<li className="list-disc ml-8">By email: killiandebacker@gmail.com</li>
			</ul>
		</div>
	);
};
