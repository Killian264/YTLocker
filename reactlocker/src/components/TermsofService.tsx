...
export const TermsofService: React.FC<ClassNameProp> = ({ className, OnBack }) => {
	return (
		<div className="bg-primary-700 absolute top-0 bottom-0 left-0 right-0 mx-auto my-auto w-full h-full md:w-9/12 md:h-4/6 overflow-scroll border-2 p-5 rounded overflow-x-hidden">
			<div className="flex justify-between">
				<h2 className="pb-3 pt-3 text-3xl">
					<strong>Terms and Conditions</strong>
				</h2>
				<div className="my-auto">
					<Button color={"primary"} size={"medium"} onClick={OnBack}>
						Back
					</Button>
				</div>
			</div>
			<p className="pb-3 pt-3">Welcome to YTLocker!</p>
			<p className="pb-3 pt-3">
				These terms and conditions outline the rules and regulations for the use of YTLocker's
				Website, located at https://ytlocker.com/.
			</p>
			<p className="pb-3 pt-3">
				By accessing this website we assume you accept these terms and conditions. Do not continue to
				use YTLocker if you do not agree to take all of the terms and conditions stated on this page.
			</p>
			<p className="pb-3 pt-3">
			...
			<p className="pb-3 pt-3">
				We employ the use of cookies. By accessing YTLocker, you agreed to use cookies in agreement
				with the YTLocker's Privacy Policy.{" "}
			</p>
			<p className="pb-3 pt-3">
			...
			<p className="pb-3 pt-3">
				Unless otherwise stated, YTLocker and/or its licensors own the intellectual property rights
				for all material on YTLocker. All intellectual property rights are reserved. You may access
				this from YTLocker for your own personal use subjected to restrictions set in these terms and
				conditions.
			</p>
			<p className="pb-3 pt-3">You must not:</p>
			<ul>
				<li className="list-disc ml-8">Republish material from YTLocker</li>
				<li className="list-disc ml-8">Sell, rent or sub-license material from YTLocker</li>
				<li className="list-disc ml-8">Reproduce, duplicate or copy material from YTLocker</li>
				<li className="list-disc ml-8">Redistribute content from YTLocker</li>
			</ul>
			<p className="pb-3 pt-3">This Agreement shall begin on the date hereof.</p>
			<p className="pb-3 pt-3">
				Parts of this website offer an opportunity for users to post and exchange opinions and
				information in certain areas of the website. YTLocker does not filter, edit, publish or review
				Comments prior to their presence on the website. Comments do not reflect the views and
				opinions of YTLocker,its agents and/or affiliates. Comments reflect the views and opinions of
				the person who post their views and opinions. To the extent permitted by applicable laws,
				YTLocker shall not be liable for the Comments or for any liability, damages or expenses caused
				and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments
				on this website.
			</p>
			<p className="pb-3 pt-3">
				YTLocker reserves the right to monitor all Comments and to remove any Comments which can be
				considered inappropriate, offensive or causes breach of these Terms and Conditions.
			</p>
			<p className="pb-3 pt-3">You warrant and represent that:</p>
			<ul>
			...
			<p className="pb-3 pt-3">
				You hereby grant YTLocker a non-exclusive license to use, reproduce, edit and authorize others
			...
			<ul>
				<li className="list-disc ml-8">Government agencies;</li>
				<li className="list-disc ml-8">Search engines;</li>
				<li className="list-disc ml-8">News organizations;</li>
				<li className="list-disc ml-8">
			...
			<ul>
				...
				<li className="list-disc ml-8">dot.com community sites;</li>
				<li className="list-disc ml-8">associations or other groups representing charities;</li>
				<li className="list-disc ml-8">online directory distributors;</li>
				<li className="list-disc ml-8">internet portals;</li>
				<li className="list-disc ml-8">accounting, law and consulting firms; and</li>
				<li className="list-disc ml-8">educational institutions and trade associations.</li>
			</ul>
			<p className="pb-3 pt-3">
				...
				visibility of the hyperlink compensates the absence of YTLocker; and (d) the link is in the
			...
			<p className="pb-3 pt-3">
				...
				to our website, you must inform us by sending an e-mail to YTLocker. Please include your name,
			...
			<p className="pb-3 pt-3">Approved organizations may hyperlink to our Website as follows:</p>
			<ul>
				<li className="list-disc ml-8">By use of our corporate name; or</li>
				<li className="list-disc ml-8">By use of the uniform resource locator being linked to; or</li>
				<li className="list-disc ml-8">
			...
			<p className="pb-3 pt-3">
				No use of YTLocker's logo or other artwork will be allowed for linking absent a trademark
				license agreement.
			</p>
			<h3 className="text-2xl">
			...
			<p className="pb-3 pt-3">Please read Privacy Policy</p>
			<h3 className="text-2xl">
