...
// IYoutubePlaylistService is an autogenerated mock type for the IYoutubePlaylistService type
type IYoutubePlaylistService struct {
	mock.Mock
}

// Create provides a mock function with given fields: playlist
func (_m *IYoutubePlaylistService) Create(playlist models.Playlist) (models.Playlist, error) {
...
func (_m *IYoutubePlaylistService) Initalize(configData models.YoutubeClientConfig, tokenData models.YoutubeToken) {
	_m.Called(configData, tokenData)
}

// Insert provides a mock function with given fields: playlist, video
func (_m *IYoutubePlaylistService) Insert(playlist models.Playlist, video models.Video) error {
